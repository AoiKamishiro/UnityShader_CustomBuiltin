...
namespace AKSBuiltin
{
    public class AKSManager : MonoBehaviour
    {
        ...
        private const string url = "https://api.github.com/repos/AoiKamishiro/UnityShader_CustomBuiltin/releases/latest";
        ...
        private static void CheckVersion()
        {
            ...
            // Check Local Version
            string localVersion = EditorUserSettings.GetConfigValue("akbuiltin_version_local") ?? "";
            ...
            // Set Local Version
            EditorUserSettings.SetConfigValue("akbuiltin_version_local", version);
            // Get Remote Version
...
#pragma warning restore 0618
            ...
            EditorUserSettings.SetConfigValue("aksbuiltin_need_update", NeedUpdate().ToString());
        }
...
#pragma warning restore 0618
        ...
        private static void UpdateHandler(string apiResult)
        {
            ...
            EditorUserSettings.SetConfigValue("akbuiltin_version_remote", version);
        }

        private static bool NeedUpdate()
        {
            bool needUpdate = false;
            bool parseLocal = double.TryParse((EditorUserSettings.GetConfigValue("akbuiltin_version_local")).Substring(1), out double localVer);
            bool parseRemote = double.TryParse((EditorUserSettings.GetConfigValue("akbuiltin_version_remote")).Substring(1), out double remoteVer);
        ...
        {
            EditorGUILayout.LabelField(AKSStyles.localVer + EditorUserSettings.GetConfigValue("akbuiltin_version_local"));
